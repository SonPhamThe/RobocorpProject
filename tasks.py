...
def robot_spare_bin_python():
    ...
    browser.configure(
        slowmo=3000, # điều chỉnh thời gian mở trang web
    )
...
def login_to_website():
    ...
    page.fill("input[name='password']", "thoushallnotpass")
...
def export_as_pdf():
    ...
    pdf = PDF()
    pdf.html_to_pdf(sales_results_html, "output/sales_result.pdf")
